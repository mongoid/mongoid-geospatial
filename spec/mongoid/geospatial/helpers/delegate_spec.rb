...
describe Mongoid::Fields do
  context 'delegate' do
    ...
    context 'x, y helpers' do
      ...
      it 'sets instance method x' do
        expect(bus.x).to eq(7)
      end

      it 'sets instance method y' do
    ...
    it 'sets instance methods x= and y=' do
    ...
    it 'works fine with default values' do
    ...
    it 'does not work fine with nils' do
