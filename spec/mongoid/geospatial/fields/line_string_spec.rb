...
describe Mongoid::Geospatial::LineString do
  describe '(de)mongoize' do
    ...
    it 'correctly (de)mongoize a LineString field' do
      # Test instantiation
    ...
    it 'grows with line_string += point' do
    ...
    it 'does not grow with parent.line_string << point — mongoid does not track <<' do
      river = River.create!(name: 'Amazonas', course: [[1, 1], [9, 9]])
      river.course << [10, 10]
      river.save
