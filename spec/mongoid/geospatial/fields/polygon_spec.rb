...
describe Mongoid::Geospatial::Polygon do
  it 'has correct indexes on farm' do
    Farm.create_indexes
    expect(Farm.collection.indexes.get(geom: '2dsphere')).not_to be_nil
  end

  describe '(de)mongoize' do
    it 'supports a field mapped as polygon' do
    ...
    it 'stores as an array on mongo' do
    ...
    describe 'with rgeo' do
      ...
      it 'provides a #to_rgeo method returning an RGeo polygon object' do
